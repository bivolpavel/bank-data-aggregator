...
@Component("com.paj.psd2.aggregator.client.generated.api.AccountTransactionsApi")
public class AccountTransactionsApi {
     ...
     */
    public TransactionsResponse v2AccountsAccountIdTransactionsGet(UUID accountId, UUID xRequestID, String authorization, String signature, String digest, OffsetDateTime date, String dateFrom, String dateTo, String currency, Integer limit) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'accountId' is set
        if (accountId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'accountId' when calling v2AccountsAccountIdTransactionsGet");
        }
        // verify the required parameter 'xRequestID' is set
        if (xRequestID == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xRequestID' when calling v2AccountsAccountIdTransactionsGet");
        }
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'authorization' when calling v2AccountsAccountIdTransactionsGet");
        }
        // verify the required parameter 'signature' is set
        if (signature == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'signature' when calling v2AccountsAccountIdTransactionsGet");
        }
        // verify the required parameter 'digest' is set
        if (digest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'digest' when calling v2AccountsAccountIdTransactionsGet");
        }
        // verify the required parameter 'date' is set
        if (date == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'date' when calling v2AccountsAccountIdTransactionsGet");
        }
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("account-id", accountId);
        String path = UriComponentsBuilder.fromPath("/v2/accounts/{account-id}/transactions").buildAndExpand(uriVariables).toUriString();
